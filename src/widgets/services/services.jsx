...
const Services = () => {
    ...
    return (
        <div style={{
            ...
            <div className='w-full text-start flex-wrap flex items-center justify-between'>
                ...
                >
                    <SwiperSlide style={styles.slide}>
                        <div className='text-2xl w-full text-start p-[25px]'>
                            <h1>Ресницы и брови</h1>
                        </div>
                        <img src={"https://avatars.mds.yandex.net/i?id=ccc2795f5cf5a20db97e9149b23f99bc_sr-5419733-images-thumbs&n=13"} alt={""} style={styles.slideImage} />
                    </SwiperSlide>
                    <SwiperSlide style={styles.slide}>
                        <div className='text-2xl w-full text-start p-[25px]'>
                            <h1>Ресницы и брови</h1>
